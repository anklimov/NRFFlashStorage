...
boolean NRFFlashStorage::write(uint32_t address, byte value) {
  uint32_t retCode;
...
boolean NRFFlashStorage::write(uint32_t address, byte *data, uint32_t dataLength) {
  uint32_t retCode;
...
boolean NRFFlashStorage::write_unlocked(uint32_t address, byte value) {
  uint32_t retCode;
  uint32_t byteLength = 1;  
  byte *data;
...
boolean NRFFlashStorage::write_unlocked(uint32_t address, byte *data, uint32_t dataLength) {
  uint32_t retCode;
